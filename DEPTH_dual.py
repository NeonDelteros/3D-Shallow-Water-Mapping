...
class DepthControlSystem:
    def __init__(self, mode_switch_pin=5):
        ...
        self.gnss = GNSSReaderDual()  # Automatically detects two USB GNSS receivers
    ...
    def auto_control_loop(self):
        for port, msg in self.gnss.read_sentences():
            ...
            if isinstance(msg, GGAData):
                ...
                # Different logic for each GNSS port
                print(f"[{port}] Lat: {lat}, Lon: {lon}, Alt: {msg.altitude}")
